# Things I've learned!
<sup>이제 목차를 써야할 수준에 다다랐다...</sup><br>
🏷️[&출력](#1-문자--출력-)&emsp;🏷️[선 문자](#2-ㅂ한자)&emsp;🏷️[유니코드](#3-유니코드-형식-u)&emsp;🏷️[소수점](#4-코드업-1015번-소수점-출력)&emsp;🏷️[출력 자릿수](#5-코드업-1019번-연월일-출력)&emsp;🏷️[배열](#6-코드업-1021번-배열-메모리-포인터)&emsp;🏷️[포인터](#7-포인터)&emsp;🏷️[문자열 입력함수](#8-문자열-입력-함수)<br>🏷️[NULL](#9-null)&emsp;🏷️[단항 연산자](#10-코드업-1040번-단항-연산자--)&emsp;🏷️[값의 덧셈](#11-문자로-값으로-덧셈을-할-수-있다)&emsp;🏷️[형 변환](#12-코드업-1042번-형-변환type-casting)&emsp;🏷️[비트 시프트 연산자](#13-코드업-1047번-비트-시프트-연산자)&emsp;🏷️[논리 연산자](#14-논리-연산자)&emsp;🏷️[3항 연산](#15-3항-연산)<br>🏷️[goto레이블](#16-goto-레이블)&emsp;🏷️[컴퓨터 용량 단위](#17-컴퓨터-용량-단위)&emsp;
...
## 12. [코드업 1042번] 형 변환*type casting*
C언어에서<br>
...
|비트 연산자 종류|설명|연산 이름|
|:---:|:---:|:---:|
|```~```<br><sub>called tilde</sub>|비트를 1이면 0으로, 0이면 1로 반전시킴|비트 NOT 연산|
|```&```|대응되는 비트가 모두 1이면 1을 반환함|비트 AND 연산|
|```\|```|대응되는 비트 중에서 하나라도 1이면 1을 반환함|비트 OR 연산|
|```^```|대응되는 비트가 서로 다르면 1을 반환함|비트 XOR 연산|
### *얘네를 왜 쓰는 걸까?*
* 2의 보수를 표현하거나
* 그래픽 처리<sub>ex) 두 장의 이미지가 겹쳐졌을 때 색이 서로 다른 부분 처리 가능</sub>를 하는데에 이용됨
* ip 주소 & 연산 시, 두 컴퓨터가 같은 네트워크에 있는지 아닌지 판단하기도 함

[*source*](http://www.tcpschool.com/c/c_refer_bitCalculation)
<br><br>
...
* 여기에서 **움직인다**라는 것은 아래와같음

||**8**<sub>(=2<sup>3</sup>)</sub>|**4**<sub>(=2<sup>2</sup>)</sub>|**2**<sub>(=2<sup>1</sup>)</sub>|**1**<sub>(=2<sup>0</sup>)</sub>|||
|---:|---:|---:|---:|---:|---:|---:|
|5|0|1|0|1|||
|5>>2|0|0|0|1|0|1|
|5<<2|1|0|1|0|||
...
|논리 연산자 종류|의미|내용|
|:---:|:---:|:---:|
|```!```<br>(not)|주어진 값의 반대|false의 0이 주어졌다면<br>!0은 true인 1 의미|
|```&&```<br>(and)|둘 다 만족하는 경우|둘 다 true여야 1 리턴|
|```\|\|```<br>(or)|하나의 경우만 만족하는 경우|둘 다 false여야 0 리턴|

## 15. 3항 연산
### 3항 연산 형식
<pre><조건식> ? <참일 때의 값> : <거짓일 때의 값></pre>
<p align="right"><sub>어떻게 이런 형식을 생각해냈을까...</sub></p>
...
<details>
<summary><code>0이 입력될 때까지 무한 출력되는 코드</code></summary>
<div markdown="1">
...
<div align="center"><img src="https://github.com/redzzzi/C23summer/assets/127263392/4bd32ec4-1e91-4007-8d97-c5ffeda70df6" width="300px"></div>
</details>
...
|:---:|:---:|:---:|:---:|:---:|:---:|
|1 KB|1024 B|2<sup>10</sup>|1 TB|1024 GB|2<sup>40</sup>|
|1 MB|1024 KB|2<sup>20</sup>|1 PB|1024 TB|2<sup>50</sup>|
|1 GB|1024 MB|2<sup>30</sup>|1 EB|1024 PB|2<sup>60</sup>|
</div>
